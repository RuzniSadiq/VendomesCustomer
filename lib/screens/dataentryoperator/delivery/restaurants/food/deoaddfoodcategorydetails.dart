...
class AddFoodCategoryDetails extends StatefulWidget {
  //const AddFoodCategoryDetails({Key? key}) : super(key: key);

  String? uid;
  String? restaurantid;
  AddFoodCategoryDetails(this.uid, this.restaurantid);

  @override
  State<AddFoodCategoryDetails> createState() => _AddFoodCategoryDetailsState();
}

class _AddFoodCategoryDetailsState extends State<AddFoodCategoryDetails> {
  final _formkey = GlobalKey<FormState>();
  var _scaffoldState = new GlobalKey<ScaffoldState>();

  final TextEditingController foodCategoryNameController = TextEditingController();
    ...
    try {
      ...
      if (result != null) {
        try {
          ...
          final destination = '/foodcategoryimages/foodcategorymain/$filename';
                ...
                children: [
                  SingleChildScrollView(
                    ...
                    child: ResponsiveWidget(
                      mobile: AddFoodCategoryDetailsContainer(context, "mobile"),
                      tab: AddFoodCategoryDetailsContainer(context, "tab"),
                      desktop: AddFoodCategoryDetailsContainer(context, "desktop"),
                    ),
                  ),
                  Positioned(
                      left: 0.0,
  ...
  Container AddFoodCategoryDetailsContainer(BuildContext context, String device) {
    return Container(
      child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      TextFormField(
                        ...
                        controller: foodCategoryNameController,
                        ...
                        decoration: InputDecoration(
                          suffixIcon: IconButton(
                              ...
                              onPressed: () {
                                foodCategoryNameController..text = "";
                              }),
                        ...
                        validator: (value) {
                          if (value!.length == 0) {
                            return "Food category name cannot be empty";
                          }
                        },
                        onSaved: (value) {
                          foodCategoryNameController.text = value!;
                        },
