...
class _DeoManagePharmacyState extends State<DeoManagePharmacy> {
      ...
      m.add(AspectRatio(
        ...
        child: FirestoreQueryBuilder<Map<String, dynamic>>(
            ...
            query: FirebaseFirestore.instance
                .collection('delivery')
                .doc("9WRNvPkoftSw4o2rHGUI")
                .collection('pharmacys').where('dataentryuid', isEqualTo: widget.uid).where('date',
  ...
  InkWell CarContainer(QueryDocumentSnapshot<Map<String, dynamic>> snapshot, BuildContext context, String tex) {
    return InkWell(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) =>
