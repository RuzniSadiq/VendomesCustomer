...
class UserSupermarketOrder extends StatefulWidget {
  //const UserSupermarketOrder({Key? key}) : super(key: key);

  String? uid;
  String? city;

  UserSupermarketOrder(this.uid, this.city);

  @override
  State<UserSupermarketOrder> createState() => _UserSupermarketOrderState();
}

class _UserSupermarketOrderState extends State<UserSupermarketOrder> {
