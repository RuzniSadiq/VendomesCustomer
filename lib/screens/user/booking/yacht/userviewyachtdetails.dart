...
class UserViewYachtDetails extends StatefulWidget {
  //const UserViewYachtDetails({Key? key}) : super(key: key);
  String? uid;
  String? yachtid;
  String? city;

  UserViewYachtDetails(this.uid, this.yachtid, this.city);

  @override
  _UserViewYachtDetailsState createState() => _UserViewYachtDetailsState(yachtid);
}

class _UserViewYachtDetailsState extends State<UserViewYachtDetails> {
  var _scaffoldState = new GlobalKey<ScaffoldState>();
  String? yachtid;

  _UserViewYachtDetailsState(this.yachtid);
