...
import 'package:worldsgate/screens/user/booking/apartments/userviewapartmentdetails.dart';
...
class UserApartmentBooking extends StatefulWidget {
  //const UserApartmentBooking({Key? key}) : super(key: key);

  String? uid;
  String? city;

  //constructor
  UserApartmentBooking(this.uid, this.city);

  @override
  _UserApartmentBookingState createState() => _UserApartmentBookingState();
}

class _UserApartmentBookingState extends State<UserApartmentBooking> {
                            ...
                            return InkWell(
                              onTap: () {
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) =>
                                        UserViewApartmentDetails(widget.uid,
                                            doc.id, widget.city)));
                              },
                              child: Padding(
                                padding: const EdgeInsets.only(
